...
def _publish_instagram(db, ai_result: dict, img_payload: tuple | None, wp_image_url: str, groq_key: str, groq_model: str, instagram_settings_id: int | None = None, groq_provider: str = "groq", groq_base_url: str | None = None):
    ...
    try:
        ...
        try:
            ...
            category_y_percent=ig.category_y_percent if ig.category_y_percent is not None else 0,
            banner_font_family=ig.banner_font_family or "Montserrat",
            category_font_family=ig.category_font_family or "Montserrat",
